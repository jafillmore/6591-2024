...
public final class Autos {
  ...
  // Create config for trajectory
    ...
    // Run path following command, then stop at the end.
    return red2Trajectory1ControllerCommand.andThen(() -> drive.drive(0, 0, 0, false, false));
  }
  ...
  // Create config for trajectory
    ...
    // Run path following command, then stop at the end.
    return red3Trajectory1ControllerCommand.andThen(() -> drive.drive(0, 0, 0, false, false));
  }
  ...
  // Create config for trajectory
    ...
    // Run path following command, then stop at the end.
    return blue2Trajectory1ControllerCommand.andThen(() -> drive.drive(0, 0, 0, false, false));
  }
