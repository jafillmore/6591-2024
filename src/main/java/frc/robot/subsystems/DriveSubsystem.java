...
public class DriveSubsystem extends SubsystemBase {
  ...
  SwerveDriveOdometry m_odometry = new SwerveDriveOdometry(
      ...
      Rotation2d.fromDegrees(m_pidgey.getAngle()),
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber(   "Yaw (Deg)", m_pidgey.getAngle());
  ...
  public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative, boolean rateLimit) {
    ...
    var swerveModuleStates = DriveConstants.kDriveKinematics.toSwerveModuleStates(
        fieldRelative
            ? ChassisSpeeds.fromFieldRelativeSpeeds(xSpeedDelivered, ySpeedDelivered, rotDelivered, Rotation2d.fromDegrees(m_pidgey.getAngle()))
  ...
  public double getHeading() {
    return Rotation2d.fromDegrees(m_pidgey.getAngle()).getDegrees();
  }
...
// Toggle Drive System Debug Data
